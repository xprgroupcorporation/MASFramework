...
- Source: `StarterGuiAssets/Scripts/ClientHandler/Services/SliderUI/Type/BarSlider.luau`
- Kind: Service
- Runtime: Client
- Module path: `StarterGuiAssets/Scripts/ClientHandler/Services/SliderUI/Type/BarSlider`
...
- Provide the `Bar Slider` implementation for the MAS Framework runtime.
...
- Original file: `D:/Main Work/XPR Group Corp. All Docs/MAS Framework - Github ver/Plugin/Ref_for_documentation/MAS_Export_MAIN-BRANCH/StarterGuiAssets/Scripts/ClientHandler/Services/SliderUI/Type/BarSlider.luau`
- Documentation file: `D:/Main Work/XPR Group Corp. All Docs/MAS Framework - Github ver/Code_Documentation/MAS_Export_MAIN-BRANCH/StarterGuiAssets/Scripts/ClientHandler/Services/SliderUI/Type/BarSlider.md`
...
────────────────────────────────────────────────────
📦 BarSlider — Version 1.0 (Client) (SliderUI Service Plug-in)
