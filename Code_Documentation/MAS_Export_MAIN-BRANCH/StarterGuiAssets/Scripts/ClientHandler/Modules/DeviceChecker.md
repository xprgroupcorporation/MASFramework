...
- Source: `StarterGuiAssets/Scripts/ClientHandler/Modules/DeviceChecker.luau`
- Kind: Client Module
- Runtime: Client
- Module path: `StarterGuiAssets/Scripts/ClientHandler/Modules/DeviceChecker`
...
- Provide the `Device Checker` implementation for the MAS Framework runtime.
...
- Original file: `D:/Main Work/XPR Group Corp. All Docs/MAS Framework - Github ver/Plugin/Ref_for_documentation/MAS_Export_MAIN-BRANCH/StarterGuiAssets/Scripts/ClientHandler/Modules/DeviceChecker.luau`
- Documentation file: `D:/Main Work/XPR Group Corp. All Docs/MAS Framework - Github ver/Code_Documentation/MAS_Export_MAIN-BRANCH/StarterGuiAssets/Scripts/ClientHandler/Modules/DeviceChecker.md`
...
────────────────────────────────────────────────────
📦 DeviceChecker — Version 0.1 (Client) (Module — Foundational)
