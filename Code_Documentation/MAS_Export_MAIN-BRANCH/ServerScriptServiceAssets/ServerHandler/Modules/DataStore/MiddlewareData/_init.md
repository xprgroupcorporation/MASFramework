...
- Source: `ServerScriptServiceAssets/ServerHandler/Modules/DataStore/MiddlewareData/_init.luau`
- Kind: Server Module
- Runtime: Server
- Module path: `ServerScriptServiceAssets/ServerHandler/Modules/DataStore/MiddlewareData`
...
- Provide the `Middleware Data` implementation for the MAS Framework runtime.
...
- Original file: `D:/Main Work/XPR Group Corp. All Docs/MAS Framework - Github ver/Plugin/Ref_for_documentation/MAS_Export_MAIN-BRANCH/ServerScriptServiceAssets/ServerHandler/Modules/DataStore/MiddlewareData/_init.luau`
- Documentation file: `D:/Main Work/XPR Group Corp. All Docs/MAS Framework - Github ver/Code_Documentation/MAS_Export_MAIN-BRANCH/ServerScriptServiceAssets/ServerHandler/Modules/DataStore/MiddlewareData/_init.md`
...
────────────────────────────────────────────────────
📦 Middleware — Version 0.2.1 (Server) (DataStore Module — V0.7 (First Added))
