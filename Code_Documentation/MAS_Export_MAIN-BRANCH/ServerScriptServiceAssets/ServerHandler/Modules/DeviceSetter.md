...
- Source: `ServerScriptServiceAssets/ServerHandler/Modules/DeviceSetter.luau`
- Kind: Server Module
- Runtime: Server
- Module path: `ServerScriptServiceAssets/ServerHandler/Modules/DeviceSetter`
...
- Provide the `Device Setter` implementation for the MAS Framework runtime.
...
- Original file: `D:/Main Work/XPR Group Corp. All Docs/MAS Framework - Github ver/Plugin/Ref_for_documentation/MAS_Export_MAIN-BRANCH/ServerScriptServiceAssets/ServerHandler/Modules/DeviceSetter.luau`
- Documentation file: `D:/Main Work/XPR Group Corp. All Docs/MAS Framework - Github ver/Code_Documentation/MAS_Export_MAIN-BRANCH/ServerScriptServiceAssets/ServerHandler/Modules/DeviceSetter.md`
...
────────────────────────────────────────────────────
📦 DeviceSetter — Version 0.1 (Server) (Module — Foundational)
